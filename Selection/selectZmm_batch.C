...
void selectZmm(const TString conf="zmm.conf", // input file
  ...
  // load trigger menu                                                                                                  
  const baconhep::TTrigger triggerMenu("/afs/cern.ch/user/x/xniu/ZCounting/CMSSW_8_0_14/src/BaconAna/DataFormats/data/HLT_50nsGRun");

  // load pileup reweighting file                                                                                       
  TFile *f_rw = TFile::Open("/afs/cern.ch/user/x/xniu/ZCounting/CMSSW_8_0_14/src/MitEwk13TeV/Tools/pileup_rw_baconDY.root", "read"); 
